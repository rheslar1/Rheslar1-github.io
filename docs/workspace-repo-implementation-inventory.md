...
| --- | --- | --- | --- |
| `bare-metal-custom-board-bring-up` | `include/project_runtime/`, `src/ProjectRuntime.cpp`, `tests/ProjectRuntimeTests.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | Published to existing remote `rheslar1/-bare-metal-custom-board-bring-up` because the no-leading-hyphen remote was not found. |
...
| `bbb-i2c-sensor-device-tree-overlay` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | I2C sensor and device-tree overlay model. |
...
| `bbb-modbus-industrial-iot-gateway` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | Modbus industrial gateway scaffold with C++17 runtime boundary. |
| `bbb-pru-real-time-coprocessor-driver` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | PRU real-time coprocessor driver model. |
| `bbb-safe-ab-remote-update-system` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | BBB A/B update design and host runtime model. |
| `bbb-yocto-ekg-sensor-monitor` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | BBB Yocto EKG sensor monitor project. |
| `bems-edge-ai-gateway` | `include/bems_gateway/`, `src/Gateway.cpp`, `tests/GatewayTests.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | BEMS edge AI gateway model and docs. |
| `can-bus-ecu-simulation` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | CAN ECU simulation runtime and validation docs. |
| `closed-loop-motor-control-platform` | `include/motor_control/`, `src/MotorControl.cpp`, `tests/MotorControlTests.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | Encoder, IMU, PID, current-limit, and PWM control model. |
| `connected-iot-device` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | Remote history merged while preserving implementation. |
...
| `digi-imx93-peripheral-driver` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | Digi i.MX93 peripheral driver model. |
| `drv8801-brushed-dc-motor-controller` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | Remote history merged while preserving implementation. |
| `edge-ai-tinyml-microcontroller` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | TinyML host runtime plus design package; remote history merged while preserving implementation. |
| `embedded-linux-secure-boot-ota-system` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | Embedded Linux secure boot and OTA model. |
...
| `fpga-hps-memory-mapped-driver` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | Published to existing remote `rheslar1/-fpga-hps-memory-mapped-driver` because the no-leading-hyphen remote was not found. |
| `low-power-temperature-datalogger` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | Low-power datalogger runtime and validation docs. |
| `medical-wearable-power-manager` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | Remote history merged while preserving implementation. |
| `mjpeg-video-streaming-hardware-ui` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | MJPEG video streaming and hardware UI model. |
| `mqtt-industrial-iot-gateway` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | MQTT industrial IoT gateway model. |
| `multi-sensor-i2c-spi-data-logger` | `include/data_logger/`, `src/DataLogger.cpp`, `tests/DataLoggerTests.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | Multi-bus sensor logger model. |
...
| `production-flash-test-rig` | `include/flash_rig/`, `src/FlashRig.cpp`, `tests/FlashRigTests.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | Production flashing, test fixture, and evidence model. |
| `read-only-rootfs-docker-containerization` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | Published to existing remote `rheslar1/-read-only-rootfs-docker-containerization` because the no-leading-hyphen remote was not found. |
...
| `spi-i2c-uart-mcu-bootloader` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | Multi-interface MCU bootloader model. |
| `tinyml-sensor-anomaly-detector` | `include/project_runtime/`, `src/ProjectRuntime.cpp` | `docs/detailed design archtitecture.md`, `docs/design/README.md` | TinyML anomaly detector model. |
