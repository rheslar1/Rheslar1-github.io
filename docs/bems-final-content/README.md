...
| [MySQL Backup Runbook](mysql-backup-runbook.md) | Dashboard MySQL backup, restore, retention, checksum, and cron workflow. |
...
- MySQL backup scripts: `scripts/backup-bems-mysql.sh`, `scripts/restore-bems-mysql.sh`
