...
const buildEmbeddedSystemsProject = (spec) => ({
  ...
  architecture:
    `${spec.summary} The scaffold separates source code, architecture documentation, validation notes, CI, and tests so the repository can grow into hardware-backed evidence.`,
  proofPoints: [
    {
      label: spec.label,
      title: 'Portfolio-Ready Repo Shape',
      detail:
        'The project is represented as a standalone repository concept with README, architecture, source, tests, and CI files instead of only a dashboard card.'
    },
    {
      label: 'Implementation Path',
      title: 'Starter Code Is Included',
      detail:
        'The scaffold includes a small buildable native control-profile executable so the repo has an executable starting point before hardware-specific drivers are added.'
    },
    {
      label: 'Evidence Plan',
  ...
  outcomes: [
    ...
    'Repository URL, architecture-doc URL, tags, proof points, and evidence queue are prewired.',
